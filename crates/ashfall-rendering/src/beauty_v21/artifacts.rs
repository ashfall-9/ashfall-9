//! Artifact quarantine for strict Beauty Mode.

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub struct VisualArtifactCountersV21 {
...
impl VisualArtifactCountersV21 {
...
pub struct BeautyModeQuarantineV21 {
...
impl BeautyModeQuarantineV21 {
    ...
    pub fn accepts(self, counters: VisualArtifactCountersV21) -> bool {
        ...
        let placeholder_total =
            counters.rod_humans + counters.cartoon_humans + counters.box_vehicles;
...
pub enum BeautyPrimitiveClassV21 {
    WorldMesh,
    TerrainPatch,
    PlantCluster,
    Stone,
